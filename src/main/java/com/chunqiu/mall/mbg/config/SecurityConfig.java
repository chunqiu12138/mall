...
import com.chunqiu.mall.component.RestfulAccessDeniedHandler;
import com.chunqiu.mall.dto.AdminUserDetails;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()// 由于使用的是JWT，我们这里不需要csrf
                ...
                .permitAll()
                .antMatchers("/esProduct/**", "/admin/login", "/admin/register")// 对登录注册要允许匿名访问
                .permitAll()
